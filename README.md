...
Try it live at <a href="https://presence-beta.env.daws25.com" target="_blank">https://presence-beta.env.daws25.com</a>
...
1. Access the application:
   * Using HTTPS on https://local.env.daws25.com:10443/ to test locally with the same browser polocies regarding HTTPS and CORS.
